...
if __name__ == '__main__':
    ...
    parser.add_argument('--teacher', required=True, type=str, help='huggingface teacher model name, e.g. facebook/bart-base, t5-base')
    ...
    parser.add_argument('--teacher-local-path', required=True, type=str, help='local path of huggingface teacher model name')
    parser.add_argument('--student-local-path', required=True, type=str, help='local path of huggingface student model name')
